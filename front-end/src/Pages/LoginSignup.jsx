    ...
    <div className="loginsignup">
      <div className="loginsignup-container">
        ...
        <div className="loginsignup-fields">
          ...
          <input name='email' value={formData.email} onChange={changeHandler} type="email" placeholder='Email Addre valuess' />
        ...
        <span onClick={()=>{setState("Log in")}}>  Login</span></p>:<p className="loginsignup-login">Create an account  
