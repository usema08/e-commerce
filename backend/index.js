...
const password = 'Usema@0805';
const encodedPassword = encodeURIComponent(password);

mongoose.connect(`mongodb+srv://mernstack:${encodedPassword}@cluster0.iabqqcy.mongodb.net/e-commerce`, { useNewUrlParser: true, useUnifiedTopology: true })
...
//creating end points for user log in
...
//creating end-points for popular in women
...
//creating end-points for adding product in cart data
